...
import decfund from "../../assets/ico_dash/decfund.png";
...
const DecreaseFund = () => {
  ...
  const decreseFund = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        toast.success("Fund Decreased Successfully", {
          id: toastId,
        });
...
//                       onClick={decreseFund}
//                       >
//                       <div className=" flex gap-2 font-semibold    rounded   tracking-wide Gregular       phone:text-sm text-white md:text-white  hover:text-white md:hover:bg-transparent border-gray-700">Decrease Fund
//                       </div>
//                     </button>
//                   </div>
//                 </div>
...
//               <img src={decfund} alt="" className="rounded-lg" />
